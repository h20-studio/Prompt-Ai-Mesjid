...
const LOCATIONS = [
    ...
    // ─── 20 Lokasi Buah-buahan & Sayuran ───
    { id: 'kebun_mangga', name: 'Kebun Mangga', emoji: '🥭', setting: 'a sprawling mango orchard (kebun mangga) with mature mango trees laden with ripe golden-yellow and green fruits, fallen mangoes on the grass, wooden harvest ladders leaning against trunks, woven baskets overflowing with fresh mangoes, and warm tropical sunlight filtering through the leafy canopy' },
    { id: 'kebun_jeruk', name: 'Kebun Jeruk', emoji: '🍊', setting: 'a vibrant citrus grove (kebun jeruk) with rows of orange and tangerine trees bearing bright orange fruits, the sweet citrus fragrance filling the air, wooden crates of freshly picked oranges, a small farmhouse, irrigation channels, and highland mountain views' },
    { id: 'kebun_pisang', name: 'Kebun Pisang', emoji: '🍌', setting: 'a lush banana plantation (kebun pisang) with rows of tall banana trees bearing heavy bunches of yellow and green bananas, broad green banana leaves swaying in the breeze, a traditional drying rack for banana chips, and a shady bamboo shelter' },
    { id: 'kebun_nanas', name: 'Kebun Nanas', emoji: '🍍', setting: 'a vast pineapple farm (kebun nanas) with endless rows of spiky pineapple plants bearing golden-ripe fruits, the sweet tropical aroma filling the air, harvest workers with baskets, a packing shed, red laterite soil paths, and bright tropical sunshine' },
    { id: 'kebun_pepaya', name: 'Kebun Pepaya', emoji: '🍈', setting: 'a tropical papaya garden (kebun pepaya) with tall slender papaya trees bearing clusters of large green and orange fruits near the top, broad fan-shaped leaves, a simple bamboo fence, a hand-pump well, butterflies fluttering, and warm morning sunlight' },
    { id: 'kebun_rambutan', name: 'Kebun Rambutan', emoji: '🔴', setting: 'a rambutan orchard (kebun rambutan) with large rambutan trees covered in clusters of bright red hairy fruits, children picking fruits from lower branches, woven baskets filled with fresh rambutans, dappled sunlight through the dense canopy, and a wooden bench under the shade' },
    { id: 'kebun_semangka', name: 'Kebun Semangka', emoji: '🍉', setting: 'a watermelon field (kebun semangka) with sprawling vines bearing large striped green watermelons on sandy soil, some cut open revealing bright red flesh, a farmer shelter with thatched roof, stacked watermelons ready for market, and a warm dry-season afternoon' },
    { id: 'kebun_alpukat', name: 'Kebun Alpukat', emoji: '🥑', setting: 'a highland avocado grove (kebun alpukat) with tall avocado trees bearing dark green pear-shaped fruits, cool misty mountain air, a rustic wooden sorting table with halved avocados showing creamy flesh, coffee plants growing underneath as shade crop, and panoramic valley views' },
    { id: 'kebun_salak', name: 'Kebun Salak', emoji: '🌴', setting: 'a snake fruit garden (kebun salak) at the foot of a volcano with clusters of thorny salak palms bearing brown scaly fruits, volcanic black soil, traditional bamboo harvest tools, baskets of peeled salak revealing translucent white flesh, misty volcanic slopes behind, and a small prayer shelter' },
    { id: 'kebun_kelengkeng', name: 'Kebun Kelengkeng', emoji: '🟤', setting: 'a longan orchard (kebun kelengkeng) with large spreading longan trees heavy with clusters of small brown fruits, a harvest ladder and long picking poles, woven bamboo trays of freshly picked longans, dappled golden sunlight, a wooden gazebo for resting, and birdsong filling the air' },
    { id: 'ladang_cabai', name: 'Ladang Cabai', emoji: '🌶️', setting: 'a vibrant chili pepper field (ladang cabai) with rows of chili plants bearing bright red, green, and orange peppers glistening in the sun, a traditional drying rack with dried red chilies, woven baskets of fresh harvest, a bamboo irrigation system, and the spicy aroma carried by warm breeze' },
    { id: 'ladang_tomat', name: 'Ladang Tomat', emoji: '🍅', setting: 'a highland tomato farm (ladang tomat) with rows of staked tomato plants bearing clusters of bright red and green tomatoes, morning dew on the leaves, bamboo support frames, wooden harvest crates, cool mountain air, and a simple greenhouse structure nearby' },
    { id: 'kebun_terong', name: 'Kebun Terong', emoji: '🍆', setting: 'an eggplant garden (kebun terong) with bushy eggplant plants bearing glossy deep purple fruits hanging from stems, interplanted with marigolds for pest control, a bamboo trellis system, a hand water pump, harvest baskets, and soft golden afternoon light over the kampung garden' },
    { id: 'ladang_bawang', name: 'Ladang Bawang', emoji: '🧅', setting: 'an onion and shallot field (ladang bawang merah) in a dry lowland area with neat rows of green onion shoots emerging from reddish soil, harvested shallots drying on bamboo racks in the sun, woven bags of dried shallots, a simple farmer hut, and the pungent aroma of fresh onions' },
    { id: 'ladang_wortel', name: 'Ladang Wortel', emoji: '🥕', setting: 'a highland carrot farm (ladang wortel) with rows of feathery green carrot tops in rich dark volcanic soil, freshly pulled bright orange carrots with soil still clinging, wooden wash basins, cool misty mountain atmosphere, terraced vegetable plots climbing the hillside, and a distant volcano peak' },
    { id: 'kebun_kangkung', name: 'Kebun Kangkung', emoji: '🥬', setting: 'a water spinach farm (kebun kangkung) with lush green kangkung growing in shallow flooded paddies, a farmer harvesting bundles of fresh kangkung with a sickle, water buffalo resting nearby, lotus flowers in adjacent ponds, dragonflies hovering, and warm tropical lowland atmosphere' },
    { id: 'kebun_bayam', name: 'Kebun Bayam', emoji: '🥬', setting: 'an organic spinach garden (kebun bayam) with dense rows of vibrant green and red amaranth spinach plants, raised garden beds with rich compost soil, a bamboo watering can, a small seed nursery shed, butterflies among the leaves, and gentle morning sunshine in a peri-urban garden setting' },
    { id: 'ladang_kol', name: 'Ladang Kol', emoji: '🥬', setting: 'a highland cabbage field (ladang kol) with rows of large round green and purple cabbages in rich volcanic soil, cool misty mountain air at high elevation, a simple farmworker shelter, wooden harvest crates, terraced fields stretching across the hillside, and panoramic views of cloud-covered peaks' },
    { id: 'kebun_labu', name: 'Kebun Labu', emoji: '🎃', setting: 'a pumpkin patch (kebun labu) with sprawling vines bearing large orange, green, and yellow pumpkins in a sun-drenched field, a rustic wooden cart loaded with harvested pumpkins, a scarecrow, a bamboo arch entrance, sunflowers growing along the fence, and warm golden harvest-season light' },
    { id: 'kebun_mentimun', name: 'Kebun Mentimun', emoji: '🥒', setting: 'a cucumber farm (kebun mentimun) with climbing cucumber vines on bamboo trellis frames bearing fresh green cucumbers, morning dew glistening on leaves, a traditional irrigation channel, woven baskets of harvested cucumbers, a shady rest area with bamboo bench, and a peaceful rural kampung atmosphere' }
];
...
function injectLocation(prompt, locationSetting, platform) {
    if (platform === 'image' || platform === 'grok') {
        return prompt.replace(
            /The setting (?:shows|is) [^.]+\.|The kampung background [^.]+\.|The village background [^.]+\.|Behind him,[^.]+\.|Behind her,[^.]+\.|The kampung scene behind her [^.]+\.|Village backdrop [^.]+\.|Surrounding her [^.]+\. The village setting [^.]+\./gi,
